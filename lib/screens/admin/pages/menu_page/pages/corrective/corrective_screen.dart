...
class CorrectiveScreen extends StatelessWidget {
  CorrectiveScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CustomerColumn(
      ...
      title: AppConstantsText.corrective,
      children: [
  ...
  Future<void> _showMyDialog(BuildContext context, int i) async {
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Yeni tədbir əlavə et'),
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                CustomerTextField(
                    title: 'Ad:',
                    hintText: 'Məsələn: düzəltmə',
                    controller: name),
              ],
            ),
          ),
...
class SectionList {
  static List<Section> list() {
    return [
      ...
      Section(id: 1, title: 'Düzəltmə'),
      Section(id: 1, title: 'Düzəldici tədbir'),
